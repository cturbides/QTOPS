...
export class EnrollmentSagaProxyController {
  private readonly logger = new Logger(EnrollmentSagaProxyController.name);
  ...
  async proxy(@Req() req: Request, @Res() res: Response) {
    ...
    try {
      ...
      const proxyHeaders = {
        ...
        'X-Proxied-By': 'api-gateway-enrollment-saga',
      };
