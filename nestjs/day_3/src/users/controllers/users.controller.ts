...
import { Controller, Get, Post, Body, Param, Patch, UsePipes, ValidationPipe, UnauthorizedException } from '@nestjs/common';
...
export class UsersController {
  ...
  async login(@Body() dto: LoginUserDto): Promise<LoginUserResponseDto> {
    console.log('Logging in user with data:', { ...dto, password: '***' });
